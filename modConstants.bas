...
Public Const BATCH_POSTED_BY = 6
Public Const SOURCE_NAME = 7
Public Const DATETIME_POSTED = 8
Public Const APPROVAL_STATUS = 9
Public Const APPROVAL_DESCRIPTION = 10
Public Const APPROVER_ACTION_DATES = 11
Public Const ADI_UPLOAD_ID = 12
Public Const NOTES = 13
